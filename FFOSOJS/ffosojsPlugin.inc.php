...
class FFOSOJSPlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('typography', 'FieldOptions', [
			'type' => 'radio',
			'label' => __('plugins.themes.FFOSOJS.option.typography.label'),
			'description' => __('plugins.themes.FFOSOJS.option.typography.description'),
			'options' => [
				[
					'value' => 'notoSans',
					'label' => __('plugins.themes.FFOSOJS.option.typography.notoSans'),
				],
				[
					'value' => 'notoSerif',
					'label' => __('plugins.themes.FFOSOJS.option.typography.notoSerif'),
				],
				[
					'value' => 'notoSerif_notoSans',
					'label' => __('plugins.themes.FFOSOJS.option.typography.notoSerif_notoSans'),
				],
				[
					'value' => 'notoSans_notoSerif',
					'label' => __('plugins.themes.FFOSOJS.option.typography.notoSans_notoSerif'),
				],
				[
					'value' => 'lato',
					'label' => __('plugins.themes.FFOSOJS.option.typography.lato'),
				],
				[
					'value' => 'lora',
					'label' => __('plugins.themes.FFOSOJS.option.typography.lora'),
				],
				[
					'value' => 'lora_openSans',
					'label' => __('plugins.themes.FFOSOJS.option.typography.lora_openSans'),
				],
			],
			'default' => 'notoSans',
		]);
		...
		$this->addOption('baseColour', 'FieldColor', [
			'label' => __('plugins.themes.FFOSOJS.option.colour.label'),
			'description' => __('plugins.themes.FFOSOJS.option.colour.description'),
			'default' => '#1E6292',
		]);
		...
		$this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
			'label' => __('manager.setup.contextSummary'),
				...
				[
					'value' => true,
					'label' => __('plugins.themes.FFOSOJS.option.showDescriptionInJournalIndex.option'),
				],
			],
			'default' => false,
		]);
		$this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
			'label' => __('plugins.themes.FFOSOJS.option.useHomepageImageAsHeader.label'),
			'description' => __('plugins.themes.FFOSOJS.option.useHomepageImageAsHeader.description'),
				'options' => [
				[
					'value' => true,
					'label' => __('plugins.themes.FFOSOJS.option.useHomepageImageAsHeader.option')
				],
			],
			'default' => false,
		]);
	...
	function getDisplayName() {
		return __('plugins.themes.FFOSOJS.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.FFOSOJS.description');
	}
}
